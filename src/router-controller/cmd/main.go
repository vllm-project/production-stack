...
import (
	...
	"github.com/vllm-project/production-stack/router-controller/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "27bc728d.vllm.ai",
	...
	if err = (&controller.CombinedReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "CombinedController")
		os.Exit(1)
	}
