...
class TestTokenRedactionFilter:
    ...
    def filter_instance(self):
        ...
        return utils.TokenRedactionFilter()
    ...
    def test_redact_value_with_bearer_token_preserves_scheme(
        self, filter_instance: utils.TokenRedactionFilter
    ):
    ...
    def test_filter_redacts_authorization_header(
        self, filter_instance: utils.TokenRedactionFilter, log_record: logging.LogRecord
    ):
