...
| Request handling | Reads completion prompts and extracts text from chat messages. | The current implementation tokenizes the completion `prompt` field; it does not reconstruct chat messages for lookup. |
